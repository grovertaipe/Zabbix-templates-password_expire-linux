...
Copia el script expiration_password.sh en la siguiente ruta en tu servidor Zabbix:
...
bash
Copiar código
UserParameter=expiration.pwd,bash /etc/zabbix/zabbix_agent2.d/plugins.d/expiration_password.sh
